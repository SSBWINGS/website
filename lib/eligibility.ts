...
export const ENTRIES: Entry[] = [
  ...
  { id: "cg-gd", name: "Coast Guard – Asst Commandant", service: "Coast Guard", stage: "After Graduation", minAge: 21, maxAge: 25, genders: ["male"], education: ["graduate", "engineering"], requiresUnmarried: true, requiresPcm: true, how: "CGCAT → Selection Board → Medical" },
];
