...
export const ENTRIES: Entry[] = [
  ...
  { id: "ues", name: "University Entry Scheme (Army)", service: "Army", stage: "After Graduation", minAge: 19, maxAge: 25, genders: ["male", "female"], education: ["engineering"], requiresUnmarried: true, how: "Pre-final year engineering → campus SSB → Medical (no written)" },
