...
const PAGES: Page[] = [
  {
    name: "Home", view: "/",
    items: [
      { label: "Section Order", href: "/admin/homepage", hint: "Show / hide / reorder sections" },
      ...
      { label: "Entries Marquee", href: "/admin/sections/entry_counts", hint: "Entries + recommended counts" },
      { label: "AIR-1 Marquee", href: "/admin/air1", hint: "Rank-holder cards" },
      ...
      { label: "Books — Heading", href: "/admin/sections/heading.books" },
      { label: "Mentors", href: "/admin/mentors" },
      { label: "Mentors — Heading", href: "/admin/sections/heading.mentors" },
      { label: "Four Forces", href: "/admin/four-forces", hint: "Cards, mottos, tags, images" },
      { label: "Why Us — Heading", href: "/admin/sections/whyus" },
      { label: "Why Us — Cards", href: "/admin/sections/whyus_items" },
      { label: "Upcoming Events", href: "/admin/countdown", hint: "Countdown + card colours" },
  ...
  { name: "Site-wide", items: [
    ...
    { label: "Enquiry Popup", href: "/admin/sections/enquiry_popup", hint: "Greeting popup text & delay" },
  ] },
];
